...
void Analiza (double a, double b, double dx, double& MinFVal, double& MaxFVal, double& MinFPrimVal, double& MaxFPrimVal){

    for (double i = a; i <= b; i+= dx){

        double fVal = f(i), fPrimVal = (f(i) - f(i-dx))/dx;
...
int main(){
    ...
    Analiza(0, M_PI, 0.001, MinFVal, MaxFVal, MinFPrimVal, MaxFPrimVal);
